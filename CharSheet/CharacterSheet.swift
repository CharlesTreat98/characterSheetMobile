...
var JeanV = CharacterSheet(hitPoints: 22, level: 3, name: "Jean", dateCreated: newDate, attackMod: 2)

var Yanko = CharacterSheet(hitPoints: 100, level: 9, name: "Yanko", dateCreated: newDate, attackMod: 8)

var Rand = CharacterSheet(hitPoints: 58, level: 3, name: "Rand", dateCreated: newDate, attackMod: 4)
